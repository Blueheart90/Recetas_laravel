...
@section('content')
<h2 class="text-center mb-5">Editando la Receta: <span class="font-weight-bold text-primary">{{ $receta->titulo }}</span></h2>
        ...
        <div class="col-md-8">
            <form method="POST" action="{{ route('recetas.update', ['receta' => $receta->id]) }}"  enctype="multipart/form-data" novalidate>
                ...
                <div class="form-group mt-3">
                    ...
                    <div class="mt-4">
                        <p>Imagen Actual</p>
                    <img src="{{ Storage::url($receta->imagen) }}" alt="" style="width: 300px">
                    </div>
                </div>
                <div class="form-group">
